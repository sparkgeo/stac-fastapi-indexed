...
This risk can be mitigated by a shorter indexer repeat cycle, by event-driven item updates as are intended by [#157](https://github.com/sparkgeo/stac-fastapi-indexed/issues/157), or by [enabling STAC persistence](./index-config.md#persist-stac-content).
